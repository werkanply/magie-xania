...
public class BlockMarmitecharbon extends ElementsVraiXaniaMod.ModElement {
	@GameRegistry.ObjectHolder("vrai_xania:marmitecharbon")
	public static final Block block = null;
	public BlockMarmitecharbon(ElementsVraiXaniaMod instance) {
		super(instance, 6);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("marmitecharbon"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "vrai_xania:tileentitymarmitecharbon");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("vrai_xania:marmitecharbon", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("marmitecharbon");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return "container.marmitecharbon";
		}
		...
		public String getGuiID() {
			return "vrai_xania:marmitecharbon";
		}
