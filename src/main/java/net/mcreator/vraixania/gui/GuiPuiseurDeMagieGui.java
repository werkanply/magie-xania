...
package net.mcreator.vraixania.gui;
...
import net.mcreator.vraixania.procedure.ProcedureExtracteurdemagiegui;
...
public class GuiPuiseurDeMagieGui extends ElementsVraiXaniaMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiPuiseurDeMagieGui(ElementsVraiXaniaMod instance) {
		super(instance, 30);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 85, 27) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemImperiumfleur.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
					this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 12 + 8 + sj * 18, 5 + 84 + si * 18));
			for (si = 0; si < 9; ++si)
				this.addSlotToContainer(new Slot(player.inventory, si, 12 + 8 + si * 18, 5 + 142));
		}
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				VraiXaniaMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("vrai_xania:textures/puiseur_de_magie_gui.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 70, this.guiTop + 54, 50, 20, "demarer"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			VraiXaniaMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureExtracteurdemagiegui.executeProcedure($_dependencies);
			}
		}
	}
